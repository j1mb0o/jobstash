...
def test_fetch_jobs_discards_title_mismatch_before_saving(
    client: TestClient, monkeypatch
) -> None:
    class TitleMismatchClient:
        def __init__(self, *args: Any, **kwargs: Any) -> None:
            pass
            ...
            return SearchResult(
                records=[
                    JobRecord(
                        ...
                        post_time="1 day ago",
                        url="https://www.linkedin.com/jobs/view/4123456789",
                        search_query="Junior ML Engineer",
                        seniority=seniority,
                        requested_positions="ML engineer",
                        status="New",
                        details=JobDetails(
    ...
    monkeypatch.setattr(
        "src.routes.search.LinkedInClient", TitleMismatchClient, raising=True
    )
